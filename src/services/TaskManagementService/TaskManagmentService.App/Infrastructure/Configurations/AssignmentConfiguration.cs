    ...
    private static List<Assignment> GenerateAssignmentsList()
    {
        return [
            ...
            new Assignment
            {
                ...
                ProjectId = Guid.Parse("11111111-1111-1111-1111-111111111112"),
            ...
            new Assignment
            {
                ...
                ProjectId = Guid.Parse("11111111-1111-1111-1111-111111111115"),
                AssignmentGroupId = Guid.Parse("11111111-1111-1111-1111-111111111111"),
            ...
            new Assignment
            {
                ...
                ProjectId = Guid.Parse("11111111-1111-1111-1111-111111111113"),
            ...
            new Assignment
            {
                ...
                ProjectId = Guid.Parse("11111111-1111-1111-1111-111111111114"),
                AssignmentGroupId = Guid.Parse("11111111-1111-1111-1111-111111111113"),
